...
const Error = () => {
    return <>
                ...
                <svg id="mainImage_create" data-name="mainImage" xmlns="http://www.w3.org/2000/svg"
                     viewBox="0 0 171.2 81.5">
                    <path id="c-1" className="changeColor cls-1"
                    ...
                    <rect id="c-2" className="changeColor cls-7" x="74.82" y="26.48" width="19.14" height="2.45"
                          transform="translate(1.29 -3.65) rotate(2.49)" fill={"rgb(128,0,0"}/>
                    <path id="c-3" className="changeColor cls-7"
                          d="M84.36,18.69h.5a7.8,7.8,0,0,1,7.8,7.8v0a0,0,0,0,1,0,0H76.56a0,0,0,0,1,0,0v0A7.8,7.8,0,0,1,84.36,18.69Z"
                          transform="translate(1.06 -3.66) rotate(2.49)" fill={"rgb(128,0,0"}/>
                    <polygon id="c-4" className="changeColor cls-8"
                             points="82.44 23.89 92.18 24.32 92.59 24.34 92.48 26.84 80.96 26.33 82.44 23.89"
                             fill={"rgb(128,0,0"}/>
                    <circle className="cls-9 faceMove" cx="78.72" cy="23.73" r="3.73"/>
                    <circle className="cls-2 faceMove" cx="78.72" cy="23.73" r="2.36"/>
                    ...
                    <path className="cls-18 faceMove"
